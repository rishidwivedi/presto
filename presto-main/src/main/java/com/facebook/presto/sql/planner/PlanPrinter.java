...
public class PlanPrinter
{
    ...
    public static String getJsonPlanSource(PlanNode plan, Map<Symbol, Type> types, Metadata metadata)
    {
        checkNotNull(metadata, "metadata is null");
        return new JsonPlanPrinter(plan, types, metadata).printSource();
    }
